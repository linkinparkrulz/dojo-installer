        ...
        try {
            ...
            pm2.launchBus((error, pm2_bus) => {
                ...
                pm2_bus.on('process:msg', (packet) => {
                    ...
                    if (data && data.topic === IpcTopics.SET_XPUB) {
                        this.setFromIpc(data.value)
                    }

                    if (data && data.topic === IpcTopics.DELETE_XPUB) {
